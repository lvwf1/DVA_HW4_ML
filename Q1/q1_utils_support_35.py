...
# [GCC 7.2.0]
# Embedded file name: ./q1_utils_support_xx.py
# Compiled at: 2018-10-30 23:58:53
...
def convert(edge_list):
    ...
    with open(meta_path, 'w') as (meta_file):
        meta_file.write(json.dumps({'edge_path': os.path.basename(edge_path), 
         'index_path': os.path.basename(index_path), 
         'edge_count': cur, 
         'node_count': node_count, 
         'max_node': max_node}, indent=2, sort_keys=True))
    print('Meta data wrote to: %s.' % meta_path, file=sys.stderr)
# okay decompiling q1_utils_support_35.pyc
