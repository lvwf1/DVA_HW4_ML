...
try:
    ...
    if py_version[0] == 2 and py_version[1] == 7:
        from q1_utils_support_27 import convert, test_warmup_submission
    elif py_version[0] == 3 and py_version[1] == 5:
        from q1_utils_support_35 import convert, test_warmup_submission
    elif py_version[0] == 3 and py_version[1] == 6:
        from q1_utils_support_36 import convert, test_warmup_submission
    elif py_version[0] == 3 and py_version[1] == 7:
        from q1_utils_support_37 import convert, test_warmup_submission
except Exception:
    print(
        'This homework only supports python versions 2.7, 3.5, 3.6 and 3.7 '
        + 'for testing warmup code and converting edge list')
